...
document.getElementById("btnExportarPrecios").addEventListener("click", () => {
  ...
  exportarExcel([{ nombre: "Lista de Precios", data }], `JPSoft_QBV_Precios_${todayKey()}.xlsx`);
});
...
document.getElementById("btnExpVentas").addEventListener("click", () => {
  ...
  exportarExcel([{ nombre: "Ventas", data }], `JPSoft_QBV_Ventas_${desde}_${hasta}.xlsx`);
});
...
document.getElementById("btnExpCaja").addEventListener("click", () => {
  ...
  const keys = dateRange(desde, hasta);
  const data = [["Fecha","Apertura","Cierre","Turno","Fondo Inicial","Ventas","Efectivo","Débito","MP/QR","Total"]];
  ...
  exportarExcel([{ nombre: "Caja", data }], `JPSoft_QBV_Caja_${desde}_${hasta}.xlsx`);
});
...
document.getElementById("btnExpProductos").addEventListener("click", () => {
  ...
  exportarExcel([{ nombre: "Productos", data }], `JPSoft_QBV_Productos_${todayKey()}.xlsx`);
});
...
function renderUsuarios() {
  ...
  tbody.innerHTML = TODOS_USUARIOS.map(u => {
    ...
    return `<tr>
      ...
      <td><span class="badge badge-neutral">Empleado</span></td>
